...
export const Profile: React.FC = () => {
    ...
    return (
        <div title="User Profile" style={{ padding: '20px', display: 'flex', justifyContent: 'center' }}>
            <Card style={{ width: 400, textAlign: 'center', borderRadius: '10px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }}>
                <div style={{ fontSize: '24px', fontWeight: 'bold', marginBottom: '16px' }}>User Profile</div>
