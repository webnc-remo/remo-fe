...
export const MovieReviews: React.FC<MovieReviewsProps> = ({ movieId, onRefetchReviews }) => {
    const { data: movieReviews, isLoading: reviewsLoading, refetch } = useGetMovieRatingReviews(
        movieId
    );
