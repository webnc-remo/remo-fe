...
import { addMovieToPlaylistUrl, axiosInstance, createPlaylistUrl } from '../../apis';
...
export const CreatePlaylistModal = ({ isOpen, onClose, movieId }: CreatePlaylistModalProps) => {
    ...
    const handleSubmit = async (values: { name: string; description?: string }) => {
        ...
        try {
            ...
            queryClient.invalidateQueries({ queryKey: ['playlists', 'movie', movieId] });
